...
const Dashboard = () => {
  ...
  <Container>
  <Navbar.Brand><Link to="/" className="nav-link text-light"><img src={logo} className='w-50' alt="" /></Link></Navbar.Brand>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    {user?.email ?
                      ...
                      <Button onClick={logOut} className="text-primary ms-3 me-3" variant="light"> Logout</Button> :
    ...
    <Navbar.Brand > <NavItem>   <Link  to="/"><img width="40px" className="rounded-circle" src={user.photoURL} alt="" /></Link> </NavItem> </Navbar.Brand>
           ...
           <div className="row my-3">
                ...
                <div className="">
                <Link className="nav-link text-light " to={`${url}`}>HOME</Link>
                {
                    admin &&<Nav.Link>
                    <Link className="nav-link text-light" to={`${url}/checkoutallorder`}>CHECKOUT BLOG</Link>
                    <Link className="nav-link text-light " to={`${url}/manageproducts`}>MANAGE BLOG</Link>
                    <Link className="nav-link text-light " to={`${url}/addproduct`}>ADD BLOG</Link>
                    <Link className="nav-link text-light " to={`${url}/createadmin`}>CREATE ADMIN</Link>
                    </Nav.Link>
                }
                <Link className="nav-link text-light " to={`${url}/mycart`}>MY EXPERIENCE</Link>
